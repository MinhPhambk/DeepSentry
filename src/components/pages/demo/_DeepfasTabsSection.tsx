...
import DeepfasImageTab from "./DeepfasImageTab";
import DeepfasVideoTab from "./DeepfasVideoTab";
import DeepfasWebcamTab from "./DeepfasWebcamTab";

const DeepfasTabsSection = () => {
  ...
  return (
    <section className="container h-full">
      <SectionIntro
        title={{
          highLiteWords: "Phát hiện khuôn mặt giả mạo",
          ...
          <div className="space-y-3.5 pt-3">
            ...
            <div className="space-y-5 md:space-y-8 max-w-3xl">
              <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                <>
                  {activeTab === "0" && <DeepfasImageTab />}
                  {activeTab === "1" && <DeepfasVideoTab/>}
                  {activeTab === "2" && <DeepfasWebcamTab/>}
                </>
              </div>
            </div>
          </div>
...
export default DeepfasTabsSection;
