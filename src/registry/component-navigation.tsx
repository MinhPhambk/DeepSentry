...
export const navigation = [
  ...
  // sections
  {
    ...
    title: "Các tính năng",
    submenu: [
      { name: "Phát hiện ảnh Deepfake", href: `${baseUrl}/deepfake-image` },
      { name: "Phát hiện khuôn mặt Deepfake", href: `${baseUrl}/deepfake-face` },
      { name: "Phát hiện khuôn mặt giả mạo", href: `${baseUrl}/deepfas` },
    ],
  },
  // {
  //   icon: <RxSection />,
